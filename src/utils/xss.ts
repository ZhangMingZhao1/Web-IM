...
/*jshint node: true */
//@ts-nocheck
export function _getPrivFilters() {
  var LT = /</g,
    QUOT = /"/g,
    SQUOT = /'/g,
    AMP = /&/g,
  ...
  function htmlDecode(s, namedRefMap, reNamedRef, skipReplacement) {
    ...
    function regExpFunction(m, num, named, named1) {
      if (num) {
        ...
        return skipReplacement
          ...
          : num === 0x83
          ? '\u0192' // LATIN SMALL LETTER F WITH HOOK (ƒ)
          : num === 0x84
    ...
    return s === undefined
      ...
      : s
          .toString()
          .replace(NULL, '\uFFFD')
          .replace(reNamedRef, regExpFunction);
  }
  ...
  function cssUrl(s) {
    ...
    return protocol && URI_BLACKLIST_PROTOCOLS[protocol.toLowerCase()]
      ? '##' + s
      : s;
  }
  ...
  return (x = {
    ...
    yup: function(s) {
      ...
      return s
        ? htmlDecode(s, URI_PROTOCOL_NAMED_REF_MAP, null, true)
    ...
    yavu: function(s) {
      return strReplace(s, SPECIAL_ATTR_VALUE_UNQUOTED_CHARS, function(m) {
        return m === '\t'
          ...
          ? '&#10;' // in hex: 0A
          : m === '\x0B'
          ? '&#11;' // in hex: 0B  for IE. IE<9 \v equals v, so use \x0B instead
          : m === '\f'
          ? '&#12;' // in hex: 0C
          : m === '\r'
          ? '&#13;' // in hex: 0D
    ...
    yceu: function(s) {
      s = htmlDecode(s);
      return CSS_VALID_VALUE.test(s)
        ? s
        : ";-x:'" +
            cssBlacklist(s.replace(CSS_SINGLE_QUOTED_CHARS, cssEncode)) +
            "';-v:";
    },
    ...
    yced: function(s) {
      return cssBlacklist(
        htmlDecode(s).replace(CSS_DOUBLE_QUOTED_CHARS, cssEncode)
      );
    },
    ...
    yces: function(s) {
      return cssBlacklist(
        htmlDecode(s).replace(CSS_SINGLE_QUOTED_CHARS, cssEncode)
      );
    },
...
var privFilters = _getPrivFilters();
...
export const inHTMLData = privFilters.yd;
 ...
 *
 */
export const inHTMLComment = privFilters.yc;
 ...
 *
 */
export const inSingleQuotedAttr = privFilters.yavs;
 ...
 *
 */
export const inDoubleQuotedAttr = privFilters.yavd;
 ...
 *
 */
export const inUnQuotedAttr = privFilters.yavu;
 ...
 *
 */
export const uriInSingleQuotedAttr = function(s) {
 ...
 *
 */
export const uriInDoubleQuotedAttr = function(s) {
 ...
 *
 */
export const uriInUnQuotedAttr = function(s) {
 ...
 *
 */
export const uriInHTMLData = privFilters.yufull;
 ...
 *
 */
export const uriInHTMLComment = function(s) {
 ...
 *
 */
export const uriPathInSingleQuotedAttr = function(s) {
 ...
 *
 */
export const uriPathInDoubleQuotedAttr = function(s) {
 ...
 *
 */
export const uriPathInUnQuotedAttr = function(s) {
 ...
 *
 */
export const uriPathInHTMLData = privFilters.yu;
 ...
 */
export const uriPathInHTMLComment = function(s) {
 ...
 */
export const uriQueryInSingleQuotedAttr = uriPathInSingleQuotedAttr;
 ...
 */
export const uriQueryInDoubleQuotedAttr = uriPathInDoubleQuotedAttr;
 ...
 */
export const uriQueryInUnQuotedAttr = uriPathInUnQuotedAttr;
 ...
 */
export const uriQueryInHTMLData = uriPathInHTMLData;
 ...
 */
export const uriQueryInHTMLComment = uriPathInHTMLComment;
 ...
 *
 */
export const uriComponentInSingleQuotedAttr = function(s) {
 ...
 *
 */
export const uriComponentInDoubleQuotedAttr = function(s) {
 ...
 *
 */
export const uriComponentInUnQuotedAttr = function(s) {
 ...
 *
 */
export const uriComponentInHTMLData = privFilters.yuc;
 ...
 */
export const uriComponentInHTMLComment = function(s) {
 ...
 *
 */
export const uriFragmentInSingleQuotedAttr = function(s) {
 ...
 *
 */
export const uriFragmentInDoubleQuotedAttr = function(s) {
 ...
 *
 */
export const uriFragmentInUnQuotedAttr = function(s) {
 ...
 */
export const uriFragmentInHTMLData = uriComponentInHTMLData;
 ...
 */
export const uriFragmentInHTMLComment = uriComponentInHTMLComment;
